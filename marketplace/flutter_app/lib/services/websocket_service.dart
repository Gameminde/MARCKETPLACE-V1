...
class WebSocketService {
  ...
  Stream<WebSocketMessage> get notificationStream =>
      _notificationController.stream;
  Stream<WebSocketMessage> get orderUpdateStream =>
  ...
  Future<void> disconnect() async {
    ...
    await _channel?.sink.close(1001); // goingAway code
...
class WebSocketManager {
  ...
  WebSocketService get service {
    _service ??= WebSocketService.instance;
    return _service!;
  }
