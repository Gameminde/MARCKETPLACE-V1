...
class AuthProvider extends ChangeNotifier {
  ...
  Map<String, bool> get passwordRequirements => Map.unmodifiable(_passwordRequirements);
  ...
  Future<bool> updateProfile(Map<String, dynamic> updates) async {
    ...
    try {
      final updatedUser = await _authService.updateProfile(_accessToken!, updates);
  ...
  Future<bool> resendEmailVerification() async {
    ...
    try {
      final success = await _authService.resendEmailVerification(_currentUser!.email);
  ...
  Future<void> _saveUserProfile() async {
    if (_currentUser != null) {
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString('user_profile', json.encode(_currentUser!.toJson()));
    }
  }
